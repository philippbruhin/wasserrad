'use strict';var image_path="",image_up="/xwiki/resources/js/xwiki/table/img/arrow-up.gif?cache-version=1648720710000",image_down="/xwiki/resources/js/xwiki/table/img/arrow-down.gif?cache-version=1648720710000",image_none="/xwiki/resources/js/xwiki/table/img/arrow-none.gif?cache-version=1648720710000",TblId,StartRow,SearchFlt,ModFn,ModFnId;TblId=[];StartRow=[];ModFn=[];ModFnId=[];addEvent(window,"load",init_sortnfilter);var SORT_COLUMN_INDEX;function init_sortnfilter(){sortables_init();filterable_init()}
