'use strict';define("xwiki-page-ready",[],function(){let d,f=new Promise(b=>{d=b}),k=0,g=new Map,l,a=(b,h)=>{clearTimeout(l);const e=k++;g.set(e,h);b.catch(()=>{}).finally(()=>{g.delete(e);g.size||(l=setTimeout(d,10))})};const c=b=>{f=f.then(b).catch(()=>{})};c(()=>{a=()=>{}});return window.xwikiPageReady={delayPageReady:function(){return a.apply(this,arguments)},getPendingDelays:()=>new Map(g),afterPageReady:c}});
