...
new c.widgets.Suggest(a.down("input[type=text]"),{script:"/xwiki/bin/view/Main/?xpage=suggest&classname=XWiki.TagClass&fieldname=tags&firCol=-&secCol=-&",varname:"input",seps:"|,",shownoresults:!1,icon:"/xwiki/resources/icons/silk/tag_yellow.png?cache-version=1648720709000"})}});c.domIsLoaded&&g()||document.observe("xwiki:dom:loaded",g);return c}(XWiki||{});
