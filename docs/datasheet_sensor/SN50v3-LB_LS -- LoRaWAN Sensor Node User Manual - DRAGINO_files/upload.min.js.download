...
parameters:{name:this.file.name}});this.formData.input.fire("xwiki:html5upload:fileFinished",{source:this})}});var h=parseInt('107374182400');f.FileUploader=Class.create({options:{maxFilesize:h,fileFilter:/.*/i,enableFileInfo:!0,enableProgressInfo:!0,progressAutohide:!1,autoUpload:!0,targetURL:null,responseContainer:null,responseURL:null},messages:{UNKNOWN_ERROR:new Template("An error occurred while uploading #{name}"),
